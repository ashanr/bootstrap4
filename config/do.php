...
if ($get['cmd'] == 'approve') {
    ...
    $message = "Thank you for registering with us. Your account has been activated...
...
";
    ...
    @mail($to_email, "User Activation", $message, "From: \"Member Registration\" <auto-reply@$host>\r\n" .
