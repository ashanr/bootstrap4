    ...
    <body>
        <div class="main-wrapper">
            <div class="app" id="app">
                ...
                <!--Add System user-->
                <div class="modal modal-lg fade addNewUser" style="width: 100%;" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content" style="padding:10px;border-radius:5px; background-color: #AACAB4;">
                            <div class="modal-header">
                                <h4 class="modal-title" style="padding-left: 35px; padding-top: 15px;"><b>Add New User</b></h4>
