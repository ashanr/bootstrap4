function load_registered_customer_table(text, callBack) {
    var tableData = '';
    $.post("table_models/table_model_registered_customers.php", {table: 'load_registered_customers_table', text: text}, function (e) {
        if (e === undefined || e.length === 0 || e === null) {
            ...
            $.each(e, function (index, qData) {
                ...
                tableData += '<td>' + qData.lastname + '</td>';
                tableData += '<td>' + qData.created_at + '</td>';
