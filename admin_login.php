    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6 col-sm-12 offset-3">
                        ...
                        <div class="form-group">
                            <button type="button" id="logSystem"  class="btn btn-warning btn-display-block" style="color:#fff;font-weight: bold"> Sign In</button>
        ...
        <footer class="footer">
            ...
            <div class="footer-block author">
                <ul>
                    <li>  Nolimit Zone </li>
                    <li> <a href="index.php" style="text-decoration:none">Go to Client Area</a></li>
